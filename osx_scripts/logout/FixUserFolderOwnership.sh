...
##########################################################################################################################
## Original file published by https://github.com/aysiu/Mac-Scripts-and-Profiles                                         ##
## published under GNU General Public License 2.0 https://github.com/aysiu/Mac-Scripts-and-Profiles/blob/master/LICENSE ##
## which is of course the license for this file too                                                                     ##
##########################################################################################################################
